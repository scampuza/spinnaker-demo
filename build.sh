...
PACKAGE_PATH=build
deb-s3 upload --bucket $BUCKET --access-key-id $ACCESS_KEY_ID --secret-access-key $SECRET_ACCESS_KEY --s3-region us-east-1 --arch amd64 --codename trusty --preserve-versions true $PACKAGE_PATH/*.deb
